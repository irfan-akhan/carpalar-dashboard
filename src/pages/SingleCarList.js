    ...
    <Flex>
      ...
      >
        <Flex
          ...
          pb="0"
        >
          <Heading as="h1" size="md" color="#fff" mb="5">
            {editMode ? 'Update Mode' : 'Details'}
          </Heading>
          <ButtonGroup>
            <ModalDialog
              callback={() => {
        ...
        <Flex mt="2" justifyContent="center" px="2" width="100%">
          <Flex flexDir="column">
            <Button
              mr="2"
          ...
          <Flex flexDir="column">
            ...
            <Button
              ...
              colorScheme="blue"
              variant={activeTab === 'images' ? 'solid' : 'outline'}
              size="md"
            >
              Images
            </Button>
          ...
          >
            <form onSubmit={handleSubmit(onSubmitHandler)}>
              <Stack>
                ...
                <FormControl isReadOnly={!editMode} mb="2">
                  <FormLabel htmlFor="weekly_payment">
                    Weekly payments{' '}
                  </FormLabel>
                  <Input
